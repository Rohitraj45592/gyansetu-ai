...
# 1. Users
user1 = User(email="rohit.student@gyansetu.com", hashed_password=hash_password("rohit123"), role="student")
user2 = User(email="priya.student@gyansetu.com", hashed_password=hash_password("priya123"), role="student")
