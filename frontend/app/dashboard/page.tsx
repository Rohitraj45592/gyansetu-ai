    ...
    <div className="min-h-screen flex overflow-x-hidden" style={{ background: '#08080c' }}>
      ...
      <main className="flex-1 min-w-0 max-w-full overflow-hidden px-5 pb-28 sm:px-8 lg:px-12 pt-20 lg:pt-10">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Top stat cards — 3 across on desktop */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-6">
            ...
            <motion.div
              ...
              style={{ background: '#121218', border: '1px solid rgba(255,255,255,0.07)' }}
            >
              <div className="flex items-center justify-between mb-5">
                <div
                  className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ background: 'rgba(167,139,250,0.14)', boxShadow: '0 0 16px rgba(167,139,250,0.18)' }}
                >
                ...
                <span
                  ...
                  style={{
                    background: isGood ? 'rgba(74,222,128,0.12)' : 'rgba(245,158,11,0.12)',
                    color: isGood ? '#4ade80' : '#f59e0b'
                  }}
                >
                  {isGood ? 'Good' : 'Low'}
                </span>
              ...
              <div className="mt-4 rounded-full overflow-hidden" style={{ height: '5px', background: 'rgba(255,255,255,0.07)' }}>
                <motion.div
                  ...
                  style={{ background: 'linear-gradient(90deg, #a78bfa, #f59e0b)' }}
                />
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <div
                  className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ background: 'rgba(45,212,191,0.14)', boxShadow: '0 0 16px rgba(45,212,191,0.18)' }}
                >
              ...
              <div className="mt-4 flex items-center gap-2" style={{ color: '#2dd4bf', fontSize: '13px', fontWeight: 500 }}>
                <TrendingUp size={14} />
                <span>On track this semester</span>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <div
                  className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ background: 'rgba(245,158,11,0.14)', boxShadow: '0 0 16px rgba(245,158,11,0.18)' }}
                >
              ...
              {todayClass ? (
                <>
                  ...
                  <p className="text-sm mt-4" style={{ color: '#9090a0' }}>
                    {todayClass.start_time}–{todayClass.end_time} · {todayClass.room}
                  </p>
                </>
              ) : (
                <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-6">
            {/* Radial chart — signature glow ring */}
            <motion.div
            ...
            >
              <div className="self-start flex items-center justify-between w-full mb-4">
                ...
                <span className="text-xs font-semibold px-2.5 py-1 rounded-full" style={{ background: 'rgba(167,139,250,0.12)', color: '#c4b5fd' }}>
                  Sem 3
                </span>
              </div>
              <div
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-3 mb-2">
                      ...
                      <span
                        ...
                        style={{ color: a.percentage >= 75 ? '#4ade80' : '#f59e0b' }}
                      >
                        {a.percentage}%
                      </span>
                    </div>
                    <div className="rounded-full overflow-hidden" style={{ height: '5px', background: 'rgba(255,255,255,0.07)' }}>
                      <motion.div
                        ...
                        className="h-full rounded-full"
                        style={{ background: a.percentage >= 75 ? '#4ade80' : '#f59e0b' }}
                      />
                    </div>
                  </div>
                </div>
      ...
      {/* Floating Chat Button — small, safely inset, never overlaps content */}
      <motion.button
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
