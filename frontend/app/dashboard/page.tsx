...
export default function DashboardPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0F1419' }} className="flex overflow-x-hidden">
      ...
      <main className="flex-1 min-w-0 max-w-full overflow-hidden px-4 pb-24 sm:px-8 lg:px-14 pt-20 lg:pt-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              className="min-w-0"
              style={{
                background: 'rgba(20,25,35,0.9)', borderRadius: '16px', padding: '24px',
                border: '1px solid rgba(139,92,246,0.2)',
                boxShadow: '0 0 32px rgba(139,92,246,0.18)'
              }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
                <div style={{
                  width: '40px', height: '40px', borderRadius: '10px', background: 'rgba(139,92,246,0.15)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
                <div style={{
                  width: '40px', height: '40px', borderRadius: '10px', background: 'rgba(20,184,166,0.15)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
              ...
              style={{
                background: 'rgba(20,25,35,0.9)', borderRadius: '16px', padding: '24px',
                border: '1px solid rgba(139,92,246,0.2)', display: 'flex', flexDirection: 'column', alignItems: 'center',
                boxShadow: '0 0 32px rgba(139,92,246,0.18)'
              }}>
              <p style={{ fontSize: '14px', fontWeight: 600, color: 'white', alignSelf: 'flex-start', marginBottom: '8px' }}>Attendance Health</p>
              <div style={{ width: '192px', height: '192px', position: 'relative', filter: 'drop-shadow(0 0 18px rgba(139,92,246,0.4))' }}>
